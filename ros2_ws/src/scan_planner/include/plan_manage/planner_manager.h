...
namespace scan_planner
{
  ...
  public:
    ...
    [[nodiscard]] LocalPlanFailureReason lastLocalPlanFailureReason() const noexcept
    {
      return local_plan_failure_state_.reason();
    }
  ...
  private:
    ...
    LocalPlanFailureState local_plan_failure_state_;
    ...
    bool checkTrajectoryCollisionFree(UniformBspline position_traj) const;
    bool checkReferenceGuideCollisionFree(
